...
parser.add_argument('--dataroot', default='C:/Users/fedef/OneDrive/Desktop/Magistrale/Tesi/Data', help='Path to datasets folder')
#parser.add_argument('--rootpath', default='/home/andchri/APZSL-pub', help='Path for saving model checkpoints and results')
parser.add_argument('--rootpath', default='C:/Users/fedef/OneDrive/Desktop/Magistrale/Tesi/APZSL-pub', help='Path for saving model checkpoints and results')
